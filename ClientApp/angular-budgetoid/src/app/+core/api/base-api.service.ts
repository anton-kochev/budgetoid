...
export abstract class BaseApiService {
  ...
  // responseType, which hands the body to JSON.parse before any caller can
  // judge its shape, and it sends a `Content-Type: application/json` request
  // header that a bodyless GET has nothing to describe and that costs a CORS
  // preflight. The other verbs keep that header — correcting them is a separate
