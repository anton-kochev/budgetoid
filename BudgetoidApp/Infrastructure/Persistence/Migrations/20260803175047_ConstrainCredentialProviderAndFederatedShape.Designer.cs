...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260803175047_ConstrainCredentialProviderAndFederatedShape")]
    partial class ConstrainCredentialProviderAndFederatedShape
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("credentials", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_credentials_type_shape", "(type = 'federated' and provider is not null and subject is not null and length(subject) > 0) or (type = 'passkey' and provider is null and subject is null)");
                        });
                });
